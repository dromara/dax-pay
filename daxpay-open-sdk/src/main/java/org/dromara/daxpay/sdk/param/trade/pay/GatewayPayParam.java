...
public class GatewayPayParam extends DaxPayRequest<GatewayPayUrlResult> {
     ...
     */
    @Override
    public DaxResult<GatewayPayUrlResult> toModel(String json) {
        return JsonUtil.toBean(json, new TypeReference<DaxResult<GatewayPayUrlResult>>() {});
    }
}
