...
/// # 微信服务商分账接收方管理（商户移动端）
///
/// 对照商户 Web 版 [MchWechatIsvAllocReceiverController]，路径前缀 `/app-mch/wechat/isv-alloc-receiver`。
/// 商户号一律取自 [PaymentContext]，忽略请求中的 mchNo，防越权。
@PermCode(menuCode = PermCodes.Channel.Merchant.MENU)
@Validated
@Tag(name = "微信服务商分账接收方管理(商户移动端)")
@RestController
@RequestMapping("/app-mch/wechat/isv-alloc-receiver")
@RequiredArgsConstructor
public class AppMchWechatIsvAllocReceiverController {
    ...
    public Result<WechatIsvAllocReceiverResult> findById(
