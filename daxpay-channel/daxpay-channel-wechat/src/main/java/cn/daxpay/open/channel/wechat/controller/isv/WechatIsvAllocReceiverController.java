...
@Validated
@Tag(name = "微信服务商分账接收方管理")
@RestController
@RequestMapping("/admin/wechat/isv-alloc-receiver")
@RequiredArgsConstructor
public class WechatIsvAllocReceiverController {
    ...
    public Result<Void> updateAlias(@NotNull(message = "{validation.field.id.notNull}") Long id,
        ...
        wechatIsvAllocReceiverService.updateAlias(id, alias);
        return Res.ok();
    }
}
