package cn.daxpay.open.channel.sheng.config;
...
@Configuration
public class ShengClientConfig {

    @Bean
    public ShengChannelClient shengChannelClient(
        ...
        return channelRestClientSupport.createClient(
                restClient, channelProperties.getTwo(), ShengChannelClient.class);
    }
}
