...
/// # 支付宝直连分账接收方管理（商户端）
///
/// 对照运营端 [AlipayDirectAllocReceiverController]，路径前缀 `/mch/alipay/direct-alloc-receiver`。
/// 商户号一律取自 [PaymentContext]，忽略请求中的 mchNo，防越权。
@PermCode(menuCode = PermCodes.Channel.Merchant.MENU)
@Validated
@Tag(name = "支付宝直连分账接收方管理(商户端)")
@RestController
@RequestMapping("/mch/alipay/direct-alloc-receiver")
@RequiredArgsConstructor
public class MchAlipayDirectAllocReceiverController {
