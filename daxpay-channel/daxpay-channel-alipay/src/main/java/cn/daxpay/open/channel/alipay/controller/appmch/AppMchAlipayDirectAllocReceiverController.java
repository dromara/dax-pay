...
/// # 支付宝直连分账接收方管理（商户移动端）
///
/// 对照商户 Web 版 [MchAlipayDirectAllocReceiverController]，路径前缀 `/app-mch/alipay/direct-alloc-receiver`。
/// 商户号一律取自 [PaymentContext]，忽略请求中的 mchNo，防越权。
@PermCode(menuCode = PermCodes.Channel.Merchant.MENU)
@Validated
@Tag(name = "支付宝直连分账接收方管理(商户移动端)")
@RestController
@RequestMapping("/app-mch/alipay/direct-alloc-receiver")
@RequiredArgsConstructor
public class AppMchAlipayDirectAllocReceiverController {

    private final AlipayDirectAllocReceiverService allocReceiverService;
    ...
    private AlipayDirectAllocReceiver loadOwned(Long id) {
        AlipayDirectAllocReceiver entity = allocReceiverManager.findById(id)
