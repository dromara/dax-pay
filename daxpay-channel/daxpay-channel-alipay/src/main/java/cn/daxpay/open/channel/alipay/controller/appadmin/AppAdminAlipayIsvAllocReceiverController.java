...
public class AppAdminAlipayIsvAllocReceiverController {
    ...
    public Result<AlipayIsvAllocReceiverResult> findById(
            @NotNull(message = "{validation.field.id.notNull}") Long id) {
        return Res.ok(alipayIsvAllocReceiverService.findById(id));
    }
    ...
    public Result<Void> updateAlias(@NotNull(message = "{validation.field.id.notNull}") Long id,
        ...
        alipayIsvAllocReceiverService.updateAlias(id, alias);
        return Res.ok();
    }
}
