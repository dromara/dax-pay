...
/// # 支付宝直连退款策略
///
/// 支付宝直连模式(ProductEnum.ALIPAY)下的退款策略。
/// 从退款订单读取通道路由参数(channelMchNo / capability),
/// 组装通道凭证(委托 [AlipayDirectConfigAssembler]), 退款执行委托给 [AlipayRefundService]。
@Slf4j
@Service
@RequiredArgsConstructor
public class AlipayDirectRefundStrategy extends AbsRefundStrategy {
