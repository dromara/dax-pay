...
/// # 支付宝直连通道商户配置（商户移动端）
///
/// 对照商户 Web 版 [MchAlipayDirectChannelMerchantController]，路径前缀 `/app-mch/alipay/direct-channel-merchant`。
/// 仅提供基础信息查看（含支付宝商家识别码 alipayUserId），商户号一律取自 [PaymentContext]，防越权。
@PermCode(menuCode = PermCodes.Channel.Merchant.MENU)
@Validated
@Tag(name = "支付宝直连通道商户配置(商户移动端)")
@RestController
@RequestMapping("/app-mch/alipay/direct-channel-merchant")
@RequiredArgsConstructor
public class AppMchAlipayDirectChannelMerchantController {
