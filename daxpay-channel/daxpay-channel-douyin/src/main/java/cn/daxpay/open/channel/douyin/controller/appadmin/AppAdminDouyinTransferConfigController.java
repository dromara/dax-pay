...
/// # 抖音转账配置管理(小程序管理端镜像)
///
/// 对应 admin 版 [DouyinTransferConfigController], 全端点镜像, 复用同一 Service 与权限码。
@PermCode(menuCode = PermCodes.Channel.Merchant.MENU)
@Validated
@Tag(name = "小程序管理端-抖音转账配置管理")
@RestController
@RequestMapping("/app-admin/douyin/transfer-config")
@RequiredArgsConstructor
public class AppAdminDouyinTransferConfigController {
