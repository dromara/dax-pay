...
import cn.daxpay.open.channel.douyin.convert.direct.DouyinDirectAllocReceiverConvert;
...
/// 绑定调 addSplitReceiver, 解绑调 deleteSplitReceiver。
///
...
@TableName(value = "douyin_direct_alloc_receiver", autoResultMap = true)
public class DouyinDirectAllocReceiver extends MchBaseEntity implements ToResult<DouyinDirectAllocReceiverResult> {
    ...
    /// 转换
    @Override
    public DouyinDirectAllocReceiverResult toResult() {
        return DouyinDirectAllocReceiverConvert.CONVERT.toResult(this);
    }
}
