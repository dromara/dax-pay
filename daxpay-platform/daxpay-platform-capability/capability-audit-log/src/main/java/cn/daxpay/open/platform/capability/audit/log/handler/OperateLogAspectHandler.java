...
import cn.daxpay.open.platform.common.spring.util.AopUtil;
...
import cn.daxpay.open.platform.core.annotation.OperateLogs;
...
import cn.daxpay.open.platform.capability.audit.log.service.log.OperateLogService;
...
public class OperateLogAspectHandler {
    ...
    /// 配置织入点
    @Pointcut("@annotation(cn.daxpay.open.platform.core.annotation.OperateLog) || @annotation(cn.daxpay.open.platform.core.annotation.OperateLogs)")
