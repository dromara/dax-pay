...
import org.dromara.daxpay.platform.capability.file.code.FileUploadStatusEnum;
import org.dromara.daxpay.platform.capability.file.convert.PlatformFileRecordConvert;
...
public class PlatformFileRecord extends MpBaseEntity implements ToResult<PlatformFileRecordResult> {
    ...
    /// 访问类型
    /// @see org.dromara.daxpay.platform.capability.file.code.UploadAccessTypeEnum
