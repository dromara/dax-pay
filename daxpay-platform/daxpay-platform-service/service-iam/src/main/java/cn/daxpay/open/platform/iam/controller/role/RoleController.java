...
public class RoleController {
    private static final String VIEW_NAME_CN = "角色查看";
    private static final String VIEW_NAME_EN = "Role View";
    private static final String MANAGE_NAME_CN = "角色管理";
    private static final String MANAGE_NAME_EN = "Role Manage";
