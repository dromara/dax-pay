...
import cn.daxpay.open.platform.iam.result.auth.TwoFactorRequiredResult;
...
/// # IAM 认证异常处理
///
/// 集中处理双因素二次验证等 IAM 认证流程异常, 返回前端可识别的结构化结果。
/// 2FA 属 IAM 业务, 异常处理放在本模块, 避免下层 service-system 反向依赖 service-iam。
///
@Slf4j
