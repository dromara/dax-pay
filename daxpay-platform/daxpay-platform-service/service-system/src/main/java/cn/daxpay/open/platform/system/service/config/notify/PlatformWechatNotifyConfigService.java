package cn.daxpay.open.platform.system.service.config.notify;

import cn.daxpay.open.platform.system.convert.config.notify.PlatformWechatNotifyConfigConvert;
