package org.dromara.daxpay.platform.common.mybatisplus.aspect;
...
public class IgnoreTenantAspectHandler {
    ...
    @Around("@within(ignoreTenant) && !@annotation(org.dromara.daxpay.platform.core.annotation.IgnoreTenant)")
