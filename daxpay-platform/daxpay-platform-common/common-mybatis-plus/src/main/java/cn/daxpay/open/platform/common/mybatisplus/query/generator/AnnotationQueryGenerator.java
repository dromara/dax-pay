package cn.daxpay.open.platform.common.mybatisplus.query.generator;
...
import cn.daxpay.open.platform.common.mybatisplus.query.function.QueryBetween;
import cn.daxpay.open.platform.core.util.ClassUtils;
...
public class AnnotationQueryGenerator {
    ...
    /// 获取查询参数注解 获取顺序: 参数字段 > Entity 数据库实体字段 > 参数类 > Entity 数据库实体类
