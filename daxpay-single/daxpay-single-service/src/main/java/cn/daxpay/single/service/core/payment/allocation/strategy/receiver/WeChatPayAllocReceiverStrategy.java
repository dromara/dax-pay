...
import cn.daxpay.single.service.core.channel.wechat.service.WeChatPayAllocReceiverService;
...
public class WeChatPayAllocReceiverStrategy extends AbsAllocReceiverStrategy {
    ...
    private final WeChatPayAllocReceiverService receiverService;
    ...
    public void bind() {
        ...
        receiverService.bind(this.getAllocReceiver(),this.weChatPayConfig);
    }
    ...
    public void unbind() {
        ...
        receiverService.unbind(this.getAllocReceiver(),this.weChatPayConfig);
    }
}
