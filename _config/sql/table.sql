...
-- ----------------------------
-- Table structure for pay_gateway_aggregate_client_env
-- ----------------------------
DROP TABLE IF EXISTS "public"."pay_gateway_aggregate_client_env";
CREATE TABLE "public"."pay_gateway_aggregate_client_env" (
  "id" int8 NOT NULL,
...
;
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."id" IS '主键';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."config_id" IS '聚合配置主表ID';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."client_env" IS '客户端环境编码: wechat_pay/alipay/union_pay/douyin';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."method" IS '支付方式(METHOD 模式填)';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."channel_mch_no" IS '通道商户号(DIRECT 模式填)';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."capability" IS '支付能力(DIRECT 模式填)';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."creator" IS '创建人';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."last_modifier" IS '最后修改人';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."last_modified_time" IS '最后修改时间';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."version" IS '乐观锁版本';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_client_env"."deleted" IS '逻辑删除';
COMMENT ON TABLE "public"."pay_gateway_aggregate_client_env" IS '网关聚合扫码客户端环境配置(子表)';
...
-- ----------------------------
-- Table structure for pay_gateway_code_client_env
-- ----------------------------
DROP TABLE IF EXISTS "public"."pay_gateway_code_client_env";
CREATE TABLE "public"."pay_gateway_code_client_env" (
  "id" int8 NOT NULL,
  "mch_no" varchar(32) COLLATE "pg_catalog"."default",
  "config_id" int8 NOT NULL,
  "client_env" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
...
;
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."id" IS '主键';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."mch_no" IS '商户号';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."config_id" IS '码牌支付策略主表ID';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."client_env" IS '客户端环境: wechat_pay/alipay/union_pay/douyin';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."pay_form" IS '支付形态: h5/mini';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."method" IS '支付方式(METHOD 模式)';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."channel_mch_no" IS '通道商户号(DIRECT 模式)';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."capability" IS '支付能力(DIRECT 模式)';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."deleted" IS '逻辑删除';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."creator" IS '创建者ID';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."last_modifier" IS '最后修改者ID';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."last_modified_time" IS '最后修改时间';
COMMENT ON COLUMN "public"."pay_gateway_code_client_env"."version" IS '版本号(乐观锁)';
COMMENT ON TABLE "public"."pay_gateway_code_client_env" IS '码牌支付策略客户端环境配置(子表)';
...
-- ----------------------------
-- Table structure for wx_platform_app_auth_config
-- ----------------------------
DROP TABLE IF EXISTS "public"."wx_platform_app_auth_config";
CREATE TABLE "public"."wx_platform_app_auth_config" (
  "id" int8 NOT NULL,
  "creator" int8,
  "create_time" timestamptz(6),
  "last_modifier" int8,
...
;
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."id" IS '主键';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."creator" IS '创建者ID';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."last_modifier" IS '最后修改ID';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."last_modified_time" IS '最后修改时间';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."version" IS '版本号';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."deleted" IS '删除标志';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."wx_platform_app_id" IS '平台微信应用ID';
COMMENT ON COLUMN "public"."wx_platform_app_auth_config"."app_secret" IS '应用密钥（加密存储）';
COMMENT ON TABLE "public"."wx_platform_app_auth_config" IS '平台微信应用授权认证配置';
...
-- ----------------------------
-- Table structure for wx_mch_app_auth_config
-- ----------------------------
DROP TABLE IF EXISTS "public"."wx_mch_app_auth_config";
CREATE TABLE "public"."wx_mch_app_auth_config" (
  "id" int8 NOT NULL,
  "creator" int8,
  "create_time" timestamptz(6),
  "last_modifier" int8,
  ...
  "deleted" bool NOT NULL DEFAULT false,
  "mch_no" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "wx_mch_app_id" int8 NOT NULL,
  "app_secret" varchar(512) COLLATE "pg_catalog"."default"
)
;
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."id" IS '主键';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."creator" IS '创建者ID';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."last_modifier" IS '最后修改ID';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."last_modified_time" IS '最后修改时间';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."version" IS '版本号';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."deleted" IS '删除标志';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."mch_no" IS '商户号';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."wx_mch_app_id" IS '商户微信应用ID';
COMMENT ON COLUMN "public"."wx_mch_app_auth_config"."app_secret" IS '应用密钥（加密存储）';
COMMENT ON TABLE "public"."wx_mch_app_auth_config" IS '商户微信应用授权认证配置';
...
-- ----------------------------
-- Table structure for pay_gateway_code_config
-- ----------------------------
DROP TABLE IF EXISTS "public"."pay_gateway_code_config";
CREATE TABLE "public"."pay_gateway_code_config" (
  "id" int8 NOT NULL,
  "mch_no" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "app_id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "level" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "deleted" bool NOT NULL DEFAULT false,
  "creator" int8,
  "create_time" timestamptz(6),
  "last_modifier" int8,
...
;
COMMENT ON COLUMN "public"."pay_gateway_code_config"."id" IS '主键';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."mch_no" IS '商户号';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."app_id" IS '应用号';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."level" IS '配置深度: auto/method/direct';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."deleted" IS '逻辑删除';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."creator" IS '创建者ID';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."last_modifier" IS '最后修改者ID';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."last_modified_time" IS '最后修改时间';
COMMENT ON COLUMN "public"."pay_gateway_code_config"."version" IS '版本号(乐观锁)';
COMMENT ON TABLE "public"."pay_gateway_code_config" IS '码牌支付策略配置(应用级)';

-- ----------------------------
-- Table structure for pay_gateway_aggregate_config
-- ----------------------------
DROP TABLE IF EXISTS "public"."pay_gateway_aggregate_config";
CREATE TABLE "public"."pay_gateway_aggregate_config" (
  "id" int8 NOT NULL,
  "mch_no" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "app_id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
...
;
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."id" IS '主键';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."mch_no" IS '商户号';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."app_id" IS '应用号';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."auto_launch" IS '是否自动拉起支付';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."creator" IS '创建者ID';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."last_modifier" IS '最后修改者ID';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."last_modified_time" IS '最后修改时间';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."version" IS '版本号(乐观锁)';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."deleted" IS '逻辑删除标记';
COMMENT ON COLUMN "public"."pay_gateway_aggregate_config"."level" IS '配置深度: auto-自动/method-方式/direct-精确';
COMMENT ON TABLE "public"."pay_gateway_aggregate_config" IS '网关聚合扫码支付配置(应用级)';
...
CREATE TABLE "public"."pay_risk_hit" (
  ...
  "handle_status" varchar(20) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'pending'::character varying,
...
COMMENT ON COLUMN "public"."pay_refund_order"."order_no" IS '关联支付订单号(平台支付交易号 tradeNo)';
...
COMMENT ON COLUMN "public"."pay_refund_order"."method" IS '支付方式';
...
COMMENT ON COLUMN "public"."mch_app_notify_config"."notify_url" IS '回调地址(https)';
COMMENT ON COLUMN "public"."mch_app_notify_config"."notify_way" IS '通知方式(http-HTTP异步回调)';
COMMENT ON COLUMN "public"."mch_app_notify_config"."subscribed_events" IS '订阅事件类型(逗号分隔,TradeTypeEnum的code: pay/cashouts/settle)';
...
-- ----------------------------
-- Indexes structure for table pay_gateway_aggregate_client_env
-- ----------------------------
CREATE INDEX "idx_gateway_agg_client_env_config_id" ON "public"."pay_gateway_aggregate_client_env" USING btree (
  "config_id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."idx_gateway_agg_client_env_config_id" IS '按聚合配置 ID 查询客户端环境';
CREATE UNIQUE INDEX "uk_gateway_agg_client_env_config_env" ON "public"."pay_gateway_aggregate_client_env" USING btree (
  "config_id" "pg_catalog"."int8_ops" ASC NULLS LAST,
  "client_env" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
COMMENT ON INDEX "public"."uk_gateway_agg_client_env_config_env" IS '同一聚合配置同一客户端环境唯一';

-- ----------------------------
-- Primary Key structure for table pay_gateway_aggregate_client_env
-- ----------------------------
ALTER TABLE "public"."pay_gateway_aggregate_client_env" ADD CONSTRAINT "pk_pay_gateway_aggregate_client_env" PRIMARY KEY ("id");
...
-- ----------------------------
-- Indexes structure for table pay_gateway_code_client_env
-- ----------------------------
CREATE INDEX "idx_pay_gateway_code_client_env_config" ON "public"."pay_gateway_code_client_env" USING btree (
  "config_id" "pg_catalog"."int8_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."idx_pay_gateway_code_client_env_config" IS '按扫码配置 ID 查询客户端环境';
CREATE UNIQUE INDEX "uk_pay_gateway_code_client_env" ON "public"."pay_gateway_code_client_env" USING btree (
  "config_id" "pg_catalog"."int8_ops" ASC NULLS LAST,
  "client_env" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "pay_form" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
COMMENT ON INDEX "public"."uk_pay_gateway_code_client_env" IS '同一扫码配置+客户端环境+支付方式唯一';

-- ----------------------------
-- Primary Key structure for table pay_gateway_code_client_env
-- ----------------------------
ALTER TABLE "public"."pay_gateway_code_client_env" ADD CONSTRAINT "pay_gateway_code_client_env_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
-- Indexes structure for table wx_platform_app_auth_config
-- ----------------------------
CREATE UNIQUE INDEX "uk_wx_platform_app_auth_app_id" ON "public"."wx_platform_app_auth_config" USING btree (
  "wx_platform_app_id" "pg_catalog"."int8_ops" ASC NULLS LAST
) WHERE deleted = false;
COMMENT ON INDEX "public"."uk_wx_platform_app_auth_app_id" IS '同一平台应用授权唯一';

-- ----------------------------
-- Primary Key structure for table wx_platform_app_auth_config
-- ----------------------------
ALTER TABLE "public"."wx_platform_app_auth_config" ADD CONSTRAINT "wx_platform_app_auth_config_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
-- Indexes structure for table wx_mch_app_auth_config
-- ----------------------------
CREATE UNIQUE INDEX "uk_wx_mch_app_auth_app_id" ON "public"."wx_mch_app_auth_config" USING btree (
  "wx_mch_app_id" "pg_catalog"."int8_ops" ASC NULLS LAST
) WHERE deleted = false;
COMMENT ON INDEX "public"."uk_wx_mch_app_auth_app_id" IS '同一商户应用授权唯一';

-- ----------------------------
-- Primary Key structure for table wx_mch_app_auth_config
-- ----------------------------
ALTER TABLE "public"."wx_mch_app_auth_config" ADD CONSTRAINT "wx_mch_app_auth_config_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
-- Indexes structure for table pay_gateway_code_config
-- ----------------------------
CREATE UNIQUE INDEX "uk_pay_gateway_code_config_app" ON "public"."pay_gateway_code_config" USING btree (
  "app_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
COMMENT ON INDEX "public"."uk_pay_gateway_code_config_app" IS '同一应用扫码配置唯一';

-- ----------------------------
-- Primary Key structure for table pay_gateway_code_config
-- ----------------------------
ALTER TABLE "public"."pay_gateway_code_config" ADD CONSTRAINT "pay_gateway_code_config_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table pay_gateway_aggregate_config
-- ----------------------------
CREATE UNIQUE INDEX "uk_pay_gateway_aggregate_app" ON "public"."pay_gateway_aggregate_config" USING btree (
  "app_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
COMMENT ON INDEX "public"."uk_pay_gateway_aggregate_app" IS '同一应用聚合配置唯一';

-- ----------------------------
-- Primary Key structure for table pay_gateway_aggregate_config
-- ----------------------------
ALTER TABLE "public"."pay_gateway_aggregate_config" ADD CONSTRAINT "pk_pay_gateway_aggregate_config" PRIMARY KEY ("id");
...
CREATE INDEX "idx_pay_risk_hit_handle_status" ON "public"."pay_risk_hit" USING btree (
  "handle_status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."idx_pay_risk_hit_handle_status" IS '按处理状态筛选';
...
COMMENT ON INDEX "public"."uk_mch_notice_task_biz" IS '商户+应用+事件+业务号+协议+来源维度的幂等唯一约束';
