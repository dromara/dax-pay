...
-- ----------------------------
-- Table structure for iam_user_passkey
-- ----------------------------
...
CREATE TABLE "public"."iam_user_password_security" (
  ...
  "lock_time" timestamptz(6),
  "password_expire_time" timestamptz(6),
  "last_change_password_time" timestamptz(6),
...
CREATE TABLE "public"."pay_alloc_detail" (
  "id" int8 NOT NULL,
  "alloc_no" varchar(100) COLLATE "pg_catalog"."default" NOT NULL,
  "receiver_type" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "receiver_account" varchar(256) COLLATE "pg_catalog"."default" NOT NULL,
  "receiver_name" varchar(256) COLLATE "pg_catalog"."default",
  "amount" int8 NOT NULL,
  "result" varchar(32) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'pending'::character varying,
  "out_detail_id" varchar(150) COLLATE "pg_catalog"."default",
...
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."base_city_adjacent_id_seq"
OWNED BY "public"."base_city_adjacent"."id";
SELECT setval('"public"."base_city_adjacent_id_seq"', 1808, true);
...
-- ----------------------------
-- Indexes structure for table alipay_direct_app
-- ----------------------------
...
-- ----------------------------
-- Indexes structure for table alipay_isv_app
-- ----------------------------
...
-- ----------------------------
CREATE INDEX "idx_alipay_transfer_config_channel" ON "public"."alipay_transfer_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "deleted" "pg_catalog"."bool_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."idx_alipay_transfer_config_channel" IS '按通道商户号查询转账配置';
CREATE UNIQUE INDEX "uk_alipay_transfer_config_mch" ON "public"."alipay_transfer_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
...
-- ----------------------------
ALTER TABLE "public"."alipay_transfer_config" ADD CONSTRAINT "pk_alipay_transfer_config" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table alipay_transfer_scene_config
-- ----------------------------
CREATE INDEX "idx_alipay_transfer_scene_config_mch" ON "public"."alipay_transfer_scene_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "deleted" "pg_catalog"."bool_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."idx_alipay_transfer_scene_config_mch" IS '按通道商户号查询转账场景列表';
CREATE UNIQUE INDEX "uk_alipay_transfer_scene_config_default" ON "public"."alipay_transfer_scene_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
...
CREATE UNIQUE INDEX "uk_alipay_transfer_scene_config_scene" ON "public"."alipay_transfer_scene_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
...
-- ----------------------------
CREATE UNIQUE INDEX "uk_base_city_adjacent" ON "public"."base_city_adjacent" USING btree (
...
-- ----------------------------
CREATE INDEX "idx_douyin_transfer_config_mch" ON "public"."douyin_transfer_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "deleted" "pg_catalog"."bool_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."idx_douyin_transfer_config_mch" IS '按通道商户号查询转账配置';
CREATE UNIQUE INDEX "uk_douyin_transfer_config_mch" ON "public"."douyin_transfer_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
...
-- ----------------------------
CREATE UNIQUE INDEX "uk_mch_risk_config_mch_no" ON "public"."mch_risk_config" USING btree (
  "mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
CREATE INDEX "idx_pay_alloc_detail_alloc_no" ON "public"."pay_alloc_detail" USING btree (
...
-- ----------------------------
ALTER TABLE "public"."pay_alloc_detail" ADD CONSTRAINT "pk_pay_alloc_detail" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table pay_alloc_order
-- ----------------------------
CREATE INDEX "idx_pay_alloc_order_status_time" ON "public"."pay_alloc_order" USING btree (
  "status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
...
CREATE INDEX "idx_pay_alloc_order_trade_no" ON "public"."pay_alloc_order" USING btree (
...
CREATE UNIQUE INDEX "uk_pay_alloc_order_alloc_no" ON "public"."pay_alloc_order" USING btree (
  "alloc_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
-- Primary Key structure for table pay_alloc_order
-- ----------------------------
ALTER TABLE "public"."pay_alloc_order" ADD CONSTRAINT "pk_pay_alloc_order" PRIMARY KEY ("id");
...
-- ----------------------------
CREATE INDEX "idx_wechat_transfer_config_app" ON "public"."wechat_transfer_config" USING btree (
...
CREATE UNIQUE INDEX "uk_wechat_transfer_config" ON "public"."wechat_transfer_config" USING btree (
  "channel_mch_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
) WHERE deleted = false;
...
-- ----------------------------
ALTER TABLE "public"."wechat_transfer_config" ADD CONSTRAINT "pk_wechat_transfer_config" PRIMARY KEY ("id");
