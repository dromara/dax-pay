...
COMMENT ON TABLE base_area IS '县区�?;
...
COMMENT ON TABLE base_city IS '城市�?;
...
COMMENT ON COLUMN base_dict.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN base_dict_item.code IS '字典项编�?;
COMMENT ON COLUMN base_dict_item.name IS '名称';
COMMENT ON COLUMN base_dict_item.sort_no IS '字典项排�?;
...
COMMENT ON COLUMN base_dict_item.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN base_dict_item.version IS '版本�?;
COMMENT ON COLUMN base_dict_item.deleted IS '删除标志';
COMMENT ON TABLE base_dict_item IS '字典�?;
...
COMMENT ON COLUMN base_param.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN base_param.value IS '参数�?;
COMMENT ON COLUMN base_param.type IS '参数类型';
COMMENT ON COLUMN base_param.enable IS '启用状�?;
...
COMMENT ON TABLE base_province IS '省份�?;
...
COMMENT ON TABLE base_street IS '街道�?;
...
COMMENT ON COLUMN base_user_protocol.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN base_user_protocol.version IS '版本�?;
...
COMMENT ON COLUMN iam_client.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN iam_client.version IS '版本�?;
...
COMMENT ON COLUMN iam_perm_code.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN iam_perm_code.version IS '版本�?;
COMMENT ON COLUMN iam_perm_code.deleted IS '删除标志';
COMMENT ON COLUMN iam_perm_code.pid IS '父ID';
COMMENT ON COLUMN iam_perm_code.code IS '权限�?;
COMMENT ON COLUMN iam_perm_code.name IS '名称';
COMMENT ON COLUMN iam_perm_code.remark IS '备注';
COMMENT ON COLUMN iam_perm_code.leaf IS '是否为叶子结�?;
COMMENT ON TABLE iam_perm_code IS '权限�?;
...
COMMENT ON COLUMN iam_perm_menu.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN iam_perm_menu.hide_children_menu IS '是否隐藏子菜�?;
COMMENT ON COLUMN iam_perm_menu.component IS '组件';
COMMENT ON COLUMN iam_perm_menu.path IS '访问路径';
COMMENT ON COLUMN iam_perm_menu.redirect IS '菜单跳转地址(重定�?';
COMMENT ON COLUMN iam_perm_menu.sort_no IS '菜单排序';
COMMENT ON COLUMN iam_perm_menu.root IS '是否是一级菜�?;
...
COMMENT ON COLUMN iam_perm_path.code IS '标识编码(模块、分组标�?';
COMMENT ON COLUMN iam_perm_path.name IS '名称(请求路径、模块、分组名�?';
...
COMMENT ON COLUMN iam_role.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN iam_role_code.code_id IS '权限�?;
COMMENT ON TABLE iam_role_code IS '角色权限码关联关�?;
...
COMMENT ON COLUMN iam_user_expand_info.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN iam_user_expand_info.version IS '版本�?;
...
COMMENT ON COLUMN iam_user_info.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN iam_user_info.phone IS '手机�?;
COMMENT ON COLUMN iam_user_info.email IS '邮箱';
COMMENT ON COLUMN iam_user_info.administrator IS '是否管理�?;
COMMENT ON COLUMN iam_user_info.status IS '账号状�?;
...
COMMENT ON COLUMN pay_adapay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_adapay_config.version IS '版本�?;
COMMENT ON COLUMN pay_adapay_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_adapay_config.ada_pay_mch_no IS '汇付商户�?;
COMMENT ON COLUMN pay_adapay_config.ada_pay_app_id IS '汇付应用�?;
...
COMMENT ON COLUMN pay_adapay_config.alloc_fee IS '分账费用承担�?mch/user';
COMMENT ON COLUMN pay_adapay_config.mch_no IS '商户�?;
...
COMMENT ON COLUMN pay_aggregate_bar_pay_config.creator IS '创建�?;
COMMENT ON COLUMN pay_aggregate_bar_pay_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_aggregate_bar_pay_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_aggregate_bar_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_aggregate_bar_pay_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_aggregate_bar_pay_config.alipay_method IS '支付宝场景对应支付方�?;
...
COMMENT ON COLUMN pay_aggregate_bar_pay_config.terminal_no IS '付款终端�?;
COMMENT ON TABLE pay_aggregate_bar_pay_config IS '网关聚合付款码支付配�?;
...
COMMENT ON COLUMN pay_aggregate_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_aggregate_pay_config.version IS '乐观�?;
COMMENT ON COLUMN pay_aggregate_pay_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_aggregate_pay_config.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_aggregate_pay_config.mch_no IS '商户�?;
...
COMMENT ON COLUMN pay_aggregate_qr_pay_config.creator IS '创建�?;
COMMENT ON COLUMN pay_aggregate_qr_pay_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_aggregate_qr_pay_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_aggregate_qr_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_aggregate_qr_pay_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_aggregate_qr_pay_config.alipay_method IS '支付宝场景对应支付方�?;
...
COMMENT ON COLUMN pay_alipay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_alipay_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_alipay_config.alipay_user_id IS '是商家与支付宝签约后，商家获得的支付宝商家唯一识别码，�?2088 开头的 16 位数字组成，在开放平台中账户中心获取';
COMMENT ON COLUMN pay_alipay_config.alipay_public_key IS '支付宝公�?;
COMMENT ON COLUMN pay_alipay_config.private_key IS '应用私钥';
COMMENT ON COLUMN pay_alipay_config.app_cert IS '应用公钥证书';
COMMENT ON COLUMN pay_alipay_config.alipay_cert IS '支付宝公钥证�?;
COMMENT ON COLUMN pay_alipay_config.alipay_root_cert IS '支付宝CA根证�?;
COMMENT ON COLUMN pay_alipay_config.sandbox IS '是否沙箱环境';
COMMENT ON COLUMN pay_alipay_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_alipay_config.app_id IS '商户AppId';
COMMENT ON COLUMN pay_alipay_config.isv_no IS '服务商号';
COMMENT ON TABLE pay_alipay_config IS '支付宝配�?;
...
COMMENT ON COLUMN pay_alipay_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_alipay_isv_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_alipay_isv_config.alipay_user_id IS '是商家与支付宝签约后，商家获得的支付宝商家唯一识别码，�?2088 开头的 16 位数字组成，在开放平台中账户中心获取';
COMMENT ON COLUMN pay_alipay_isv_config.alipay_public_key IS '支付宝公�?;
COMMENT ON COLUMN pay_alipay_isv_config.private_key IS '应用私钥';
COMMENT ON COLUMN pay_alipay_isv_config.app_cert IS '应用公钥证书';
COMMENT ON COLUMN pay_alipay_isv_config.alipay_cert IS '支付宝公钥证�?;
COMMENT ON COLUMN pay_alipay_isv_config.alipay_root_cert IS '支付宝CA根证�?;
...
COMMENT ON COLUMN pay_alipay_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_alipay_sub_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_alipay_sub_config.alipay_user_id IS '支付宝商家唯一识别�?是商家与支付宝签约后，商家获得的支付宝商家唯一识别码，�?2088 开头的 16 位数字组成，在开放平台中账户中心获取';
COMMENT ON COLUMN pay_alipay_sub_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_alipay_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_alipay_sub_config.isv_no IS '服务商号';
COMMENT ON TABLE pay_alipay_sub_config IS '支付宝特约商户配�?;
...
COMMENT ON COLUMN pay_cashier_code.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_cashier_code.version IS '版本�?;
COMMENT ON COLUMN pay_cashier_code.deleted IS '逻辑删除标识';
COMMENT ON COLUMN pay_cashier_code.isv_no IS '服务商号';
COMMENT ON COLUMN pay_cashier_code.mch_no IS '商户�?;
COMMENT ON COLUMN pay_cashier_code.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_cashier_code.allocation IS '是否开启分�?;
...
COMMENT ON COLUMN pay_cashier_code.alipay_method IS '支付宝场景对应支付方�?;
...
COMMENT ON COLUMN pay_cashier_code.enable IS '状�?;
COMMENT ON COLUMN pay_cashier_code.batch_no IS '批次�?;
...
COMMENT ON COLUMN pay_cashier_code_config.creator IS '创建�?;
COMMENT ON COLUMN pay_cashier_code_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_cashier_code_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_cashier_code_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_cashier_code_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_cashier_code_config.allocation IS '是否开启分�?;
...
COMMENT ON COLUMN pay_cashier_code_config.alipay_method IS '支付宝场景对应支付方�?;
...
COMMENT ON COLUMN pay_channel_config.out_mch_no IS '通道商户�?;
...
COMMENT ON COLUMN pay_channel_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_channel_config.version IS '版本�?;
COMMENT ON COLUMN pay_channel_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_channel_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_channel_config.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_channel_const.isv IS '是否支持服务商模�?;
...
COMMENT ON COLUMN pay_checkout_counter_config.creator IS '创建�?;
COMMENT ON COLUMN pay_checkout_counter_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_checkout_counter_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_checkout_counter_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_checkout_counter_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_checkout_counter_config.bg_color IS '背景�?;
COMMENT ON COLUMN pay_checkout_counter_config.border_color IS '边框�?;
...
COMMENT ON COLUMN pay_close_record.order_no IS '支付订单�?;
COMMENT ON COLUMN pay_close_record.biz_order_no IS '商户支付订单�?;
...
COMMENT ON COLUMN pay_close_record.error_code IS '错误�?;
...
COMMENT ON COLUMN pay_close_record.mch_no IS '商户�?;
COMMENT ON COLUMN pay_close_record.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_dougong_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_dougong_isv_config.version IS '版本�? 使用乐观�?;
...
COMMENT ON COLUMN pay_dougong_isv_config.product_id IS '产品�?;
...
COMMENT ON TABLE pay_dougong_isv_config IS '斗拱服务商配�?;
...
COMMENT ON COLUMN pay_dougong_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_dougong_sub_config.version IS '版本�? 使用乐观�?;
COMMENT ON COLUMN pay_dougong_sub_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_dougong_sub_config.isv_no IS '服务商号';
COMMENT ON COLUMN pay_dougong_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_dougong_sub_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_dougong_sub_config.enable IS '是否启用';
COMMENT ON COLUMN pay_dougong_sub_config.merchant_no IS '支付通道商户�?;
COMMENT ON COLUMN pay_dougong_sub_config.read_system IS '读取服务商配�? 默认为true';
...
COMMENT ON COLUMN pay_fuyou_sub_config.term_no IS '终端�?;
COMMENT ON COLUMN pay_fuyou_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_fuyou_sub_config.app_id IS '商户AppId';
COMMENT ON COLUMN pay_fuyou_sub_config.read_system IS '读取服务商配�? 默认为true';
...
COMMENT ON COLUMN pay_gateway_pay_config.creator IS '创建�?;
COMMENT ON COLUMN pay_gateway_pay_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_gateway_pay_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_gateway_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_gateway_pay_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_gateway_pay_config.h5_auto_upgrade IS 'h5收银台自动升级聚合支�?;
...
COMMENT ON COLUMN pay_gateway_pay_read_config.creator IS '创建�?;
COMMENT ON COLUMN pay_gateway_pay_read_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_gateway_pay_read_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_gateway_pay_read_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_gateway_pay_read_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_gateway_pay_read_config.h5_read_system IS 'H5收银台读取系�?;
COMMENT ON COLUMN pay_gateway_pay_read_config.pc_read_system IS 'Pc收银台读取系�?;
COMMENT ON COLUMN pay_gateway_pay_read_config.aggregate_qr_read_system IS '聚合扫码支付读取系统';
COMMENT ON COLUMN pay_gateway_pay_read_config.aggregate_bar_read_system IS '聚合付款码支付读取系�?;
COMMENT ON COLUMN pay_gateway_pay_read_config.mini_quickly_read_system IS '小程序快捷支付读取系�?;
...
COMMENT ON COLUMN pay_hkrt_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_hkrt_isv_config.version IS '版本�?;
COMMENT ON COLUMN pay_hkrt_isv_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_hkrt_isv_config.access_id IS '接入机构标识';
COMMENT ON COLUMN pay_hkrt_isv_config.wx_channel_no IS '微信渠道�?;
...
COMMENT ON COLUMN pay_hkrt_isv_config.hkrt_agent_no IS '服务商编�?;
COMMENT ON TABLE pay_hkrt_isv_config IS '海科服务商配�?;
...
COMMENT ON COLUMN pay_hkrt_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_hkrt_sub_config.version IS '版本�?;
COMMENT ON COLUMN pay_hkrt_sub_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_hkrt_sub_config.merch_no IS '商户编号';
COMMENT ON COLUMN pay_hkrt_sub_config.pn IS 'SAAS终端�?;
COMMENT ON COLUMN pay_hkrt_sub_config.enable IS '是否启用';
COMMENT ON COLUMN pay_hkrt_sub_config.app_id IS '商户AppId';
COMMENT ON COLUMN pay_hkrt_sub_config.read_system IS '读取服务商配�? 默认为true';
...
COMMENT ON COLUMN pay_hkrt_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_hkrt_sub_config.isv_no IS '服务商号';
COMMENT ON TABLE pay_hkrt_sub_config IS '海科子商户配�?;
...
COMMENT ON COLUMN pay_isv_aggregate_bar_pay_config.creator IS '创建�?;
COMMENT ON COLUMN pay_isv_aggregate_bar_pay_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_isv_aggregate_bar_pay_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_isv_aggregate_bar_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_aggregate_bar_pay_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_isv_aggregate_bar_pay_config.alipay_method IS '支付宝场景对应支付方�?;
...
COMMENT ON TABLE pay_isv_aggregate_bar_pay_config IS 'ISV网关聚合付款码支付配�?;
...
COMMENT ON COLUMN pay_isv_aggregate_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_aggregate_pay_config.version IS '乐观�?;
...
COMMENT ON COLUMN pay_isv_aggregate_pay_config.mch_no IS '商户�?;
...
COMMENT ON COLUMN pay_isv_aggregate_qr_pay_config.creator IS '创建�?;
COMMENT ON COLUMN pay_isv_aggregate_qr_pay_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_isv_aggregate_qr_pay_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_isv_aggregate_qr_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_aggregate_qr_pay_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_isv_aggregate_qr_pay_config.alipay_method IS '支付宝场景对应支付方�?;
...
COMMENT ON COLUMN pay_isv_channel_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_channel_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_isv_checkout_counter_config.creator IS '创建�?;
COMMENT ON COLUMN pay_isv_checkout_counter_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_isv_checkout_counter_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_isv_checkout_counter_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_checkout_counter_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_isv_checkout_counter_config.bg_color IS '背景�?;
COMMENT ON COLUMN pay_isv_checkout_counter_config.border_color IS '边框�?;
...
COMMENT ON COLUMN pay_isv_gateway_config.creator IS '创建�?;
COMMENT ON COLUMN pay_isv_gateway_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_isv_gateway_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_isv_gateway_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_gateway_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_isv_gateway_config.h5_auto_upgrade IS 'h5收银台自动升级聚合支�?;
...
COMMENT ON COLUMN pay_isv_info.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_info.version IS '版本�?;
COMMENT ON COLUMN pay_isv_info.deleted IS '删除标志';
COMMENT ON COLUMN pay_isv_info.status IS '状�?;
COMMENT ON COLUMN pay_isv_info.name IS '名称';
COMMENT ON COLUMN pay_isv_info.isv_no IS '服务商号';
COMMENT ON COLUMN pay_isv_info.short_name IS '简�?;
COMMENT ON TABLE pay_isv_info IS '服务商信�?;
...
COMMENT ON COLUMN pay_isv_mini_quickly_config.creator IS '创建�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.create_time IS '创建时间';
COMMENT ON COLUMN pay_isv_mini_quickly_config.last_modifier IS '最后修改�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.version IS '版本�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.deleted IS '删除标记';
COMMENT ON COLUMN pay_isv_mini_quickly_config.mini_app_allocation IS '小程序开启分�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.mini_app_auto_allocation IS '小程序自动分�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.mini_app_limit_pay IS '限制小程序支付方�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.terminal_no IS '终端�?;
COMMENT ON COLUMN pay_isv_mini_quickly_config.isv_no IS '服务商号';
COMMENT ON TABLE pay_isv_mini_quickly_config IS 'ISV小程序快捷支付配�?;
...
COMMENT ON COLUMN pay_lakala_isv_config.lkl_app_id IS '拉卡拉应用编�?;
COMMENT ON COLUMN pay_lakala_isv_config.mch_serial_no IS '商户证书序列�?;
...
COMMENT ON COLUMN pay_lakala_isv_config.version IS '版本�?;
COMMENT ON COLUMN pay_lakala_isv_config.creator IS '创建�?;
...
COMMENT ON COLUMN pay_lakala_isv_config.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN pay_lakala_sub_config.merchant_no IS '拉卡拉商户编�?;
COMMENT ON COLUMN pay_lakala_sub_config.term_no IS '终端�?;
COMMENT ON COLUMN pay_lakala_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_lakala_sub_config.app_id IS '商户AppId';
COMMENT ON COLUMN pay_lakala_sub_config.read_system IS '读取服务商配�? 默认为true';
...
COMMENT ON COLUMN pay_lakala_sub_config.version IS '版本�?;
COMMENT ON COLUMN pay_lakala_sub_config.creator IS '创建�?;
...
COMMENT ON COLUMN pay_lakala_sub_config.last_modified_time IS '最后修改时�?;
...
COMMENT ON COLUMN pay_leshua_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_leshua_isv_config.version IS '版本�?;
...
COMMENT ON TABLE pay_leshua_isv_config IS '乐刷服务商配�?;
...
COMMENT ON COLUMN pay_leshua_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_leshua_sub_config.version IS '版本�?;
COMMENT ON COLUMN pay_leshua_sub_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_leshua_sub_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_leshua_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_leshua_sub_config.ls_mch_no IS '乐刷商户�?;
COMMENT ON COLUMN pay_leshua_sub_config.enable IS '是否启用';
COMMENT ON COLUMN pay_leshua_sub_config.read_system IS '读取服务商配�? 默认为true';
...
COMMENT ON TABLE pay_leshua_sub_config IS '乐刷子商户配�?;
...
COMMENT ON COLUMN pay_merchant_callback_task.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_merchant_callback_task.version IS '版本�?;
...
COMMENT ON COLUMN pay_merchant_callback_task.trade_no IS '本地交易�?;
...
COMMENT ON COLUMN pay_merchant_callback_task.success IS '是否发送成�?;
COMMENT ON COLUMN pay_merchant_callback_task.next_time IS '发送次�?;
COMMENT ON COLUMN pay_merchant_callback_task.send_count IS '延迟次数';
COMMENT ON COLUMN pay_merchant_callback_task.delay_count IS '下次发送时�?;
COMMENT ON COLUMN pay_merchant_callback_task.latest_time IS '最后发送时�?;
COMMENT ON COLUMN pay_merchant_callback_task.mch_no IS '商户�?;
COMMENT ON COLUMN pay_merchant_callback_task.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_order.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_order.version IS '版本�?;
COMMENT ON COLUMN pay_order.deleted IS '删除标志';
COMMENT ON COLUMN pay_order.biz_order_no IS '商户订单�?;
COMMENT ON COLUMN pay_order.order_no IS '订单�?;
COMMENT ON COLUMN pay_order.out_order_no IS '通道订单�?;
...
COMMENT ON COLUMN pay_order.refundable_balance IS '可退金额(�?';
COMMENT ON COLUMN pay_order.status IS '支付状�?;
COMMENT ON COLUMN pay_order.refund_status IS '退款状�?;
COMMENT ON COLUMN pay_order.alloc_status IS '分账状�?;
COMMENT ON COLUMN pay_order.error_msg IS '错误信息';
COMMENT ON COLUMN pay_order.mch_no IS '商户�?;
COMMENT ON COLUMN pay_order.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_order.settle_status IS '结算状�?;
COMMENT ON COLUMN pay_order.onb_mch_no IS '进件商户�?;
COMMENT ON COLUMN pay_order.payment_vendor IS '支付厂商';
COMMENT ON COLUMN pay_order.relation_order_no IS '特殊通道关联订单�?;
COMMENT ON COLUMN pay_order.trans_order_no IS '透传订单�?;
...
COMMENT ON COLUMN pay_order_expand.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_order_expand.version IS '版本�?;
COMMENT ON COLUMN pay_order_expand.deleted IS '删除标志';
COMMENT ON COLUMN pay_order_expand.mch_no IS '商户�?;
COMMENT ON COLUMN pay_order_expand.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_order_expand.bank_type IS '银行卡类�?;
COMMENT ON COLUMN pay_order_expand.promotion_type IS '参加活动类型';
COMMENT ON COLUMN pay_order_expand.ext IS '扩展参数存储字段';
COMMENT ON COLUMN pay_order_expand.relation_order_no IS '特殊通道关联订单�?;
COMMENT ON COLUMN pay_order_expand.bar_code IS '付款�?;
...
COMMENT ON COLUMN pay_order_expand.auth_code IS '付款�?;
...
COMMENT ON COLUMN pay_platform_basic_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_platform_basic_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_platform_basic_config.default_isv_no IS '默认服务�?;
...
COMMENT ON COLUMN pay_platform_integration_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_platform_integration_config.version IS '版本�?;
COMMENT ON COLUMN pay_platform_integration_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_platform_integration_config.req_sign IS '是否对请求进行验�?;
COMMENT ON COLUMN pay_platform_integration_config.req_timeout IS '是否验证请求时间是否超时';
COMMENT ON COLUMN pay_platform_integration_config.api_req_timeout IS '请求超时时间(�?';
...
COMMENT ON COLUMN pay_platform_url_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_platform_url_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_platform_website_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_platform_website_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_refund_order.order_no IS '支付订单�?;
COMMENT ON COLUMN pay_refund_order.biz_order_no IS '商户支付订单�?;
COMMENT ON COLUMN pay_refund_order.out_order_no IS '通道支付订单�?;
...
COMMENT ON COLUMN pay_refund_order.amount IS '退款金�?;
COMMENT ON COLUMN pay_refund_order.reason IS '退款原�?;
COMMENT ON COLUMN pay_refund_order.finish_time IS '退款完成时�?;
COMMENT ON COLUMN pay_refund_order.status IS '退款状�?;
...
COMMENT ON COLUMN pay_refund_order.error_code IS '错误�?;
...
COMMENT ON COLUMN pay_refund_order.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_refund_order.version IS '乐观�?;
COMMENT ON COLUMN pay_refund_order.deleted IS '删除标志';
COMMENT ON COLUMN pay_refund_order.mch_no IS '商户�?;
COMMENT ON COLUMN pay_refund_order.app_id IS '应用�?;
COMMENT ON COLUMN pay_refund_order.isv_no IS '所属服务商';
COMMENT ON COLUMN pay_refund_order.settle_status IS '结算状�?;
COMMENT ON COLUMN pay_refund_order.onb_mch_no IS '进件商户�?;
COMMENT ON COLUMN pay_refund_order.payment_vendor IS '支付厂商';
COMMENT ON COLUMN pay_refund_order.relation_order_no IS '特殊通道关联订单�?;
COMMENT ON TABLE pay_refund_order IS '退款订�?;
...
COMMENT ON COLUMN pay_sand_isv_config.sand_app_id IS '杉德代理产编�?;
...
COMMENT ON COLUMN pay_sand_settle_bind_info.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.version IS '版本�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.deleted IS '删除标志';
COMMENT ON COLUMN pay_sand_settle_bind_info.isv_no IS '服务商号';
COMMENT ON COLUMN pay_sand_settle_bind_info.mch_no IS '商户�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.onb_mch_id IS '进件商户ID';
COMMENT ON COLUMN pay_sand_settle_bind_info.sub_merchant_id IS '杉德商户�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.bank_account_type IS '银行账户类型 PUBLIC_ACCOUNT：对公帐�?PRIVATE_DEBIT_ACCOUNT：对私借记�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.bank_account_name IS '银行开户名';
COMMENT ON COLUMN pay_sand_settle_bind_info.bank_card_no IS '银行卡卡�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.bank_channel_no IS '银行联行�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.bank_account_id_card_no IS '银行开户身份证号码';
COMMENT ON COLUMN pay_sand_settle_bind_info.bank_account_phone IS '银行预留手机�?;
COMMENT ON COLUMN pay_sand_settle_bind_info.valid_date IS '换卡生效时间';
COMMENT ON TABLE pay_sand_settle_bind_info IS '杉德商户结算银行卡绑定信�?;
...
COMMENT ON COLUMN pay_sand_sub_config.store_id IS '门店�?;
COMMENT ON COLUMN pay_sand_sub_config.read_system IS '读取服务商配�? 默认为true';
...
COMMENT ON COLUMN pay_trade_callback_record.trade_no IS '本地交易�?;
COMMENT ON COLUMN pay_trade_callback_record.out_trade_no IS '通道交易�?;
...
COMMENT ON COLUMN pay_trade_callback_record.status IS '回调处理状�?;
COMMENT ON COLUMN pay_trade_callback_record.error_code IS '错误�?;
...
COMMENT ON COLUMN pay_trade_callback_record.mch_no IS '商户�?;
COMMENT ON COLUMN pay_trade_callback_record.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_trade_flow_record.trade_no IS '本地交易�?;
COMMENT ON COLUMN pay_trade_flow_record.biz_trade_no IS '商户交易�?;
COMMENT ON COLUMN pay_trade_flow_record.out_trade_no IS '通道交易�?;
COMMENT ON COLUMN pay_trade_flow_record.creator IS '创建者ID';
COMMENT ON COLUMN pay_trade_flow_record.create_time IS '创建时间';
COMMENT ON COLUMN pay_trade_flow_record.mch_no IS '商户�?;
COMMENT ON COLUMN pay_trade_flow_record.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_trade_sync_record.mch_no IS '商户�?;
COMMENT ON COLUMN pay_trade_sync_record.app_id IS '应用�?;
COMMENT ON COLUMN pay_trade_sync_record.trade_no IS '本地交易�?;
COMMENT ON COLUMN pay_trade_sync_record.biz_trade_no IS '商户交易�?;
COMMENT ON COLUMN pay_trade_sync_record.out_trade_no IS '通道交易�?;
COMMENT ON COLUMN pay_trade_sync_record.out_trade_status IS '通道返回的状�?;
COMMENT ON COLUMN pay_trade_sync_record.trade_type IS '同步类型';
COMMENT ON COLUMN pay_trade_sync_record.channel IS '同步通道';
COMMENT ON COLUMN pay_trade_sync_record.sync_info IS '网关返回的同步消�?;
COMMENT ON COLUMN pay_trade_sync_record.adjust IS '是否进行调整';
COMMENT ON COLUMN pay_trade_sync_record.error_code IS '错误�?;
...
COMMENT ON COLUMN pay_transfer_order.biz_transfer_no IS '商户转账�?;
COMMENT ON COLUMN pay_transfer_order.transfer_no IS '转账�?;
COMMENT ON COLUMN pay_transfer_order.out_transfer_no IS '通道转账�?;
...
COMMENT ON COLUMN pay_transfer_order.payee_type IS '收款人类�?;
COMMENT ON COLUMN pay_transfer_order.payee_account IS '收款人账�?;
COMMENT ON COLUMN pay_transfer_order.payee_name IS '收款人姓�?;
COMMENT ON COLUMN pay_transfer_order.status IS '状�?;
...
COMMENT ON COLUMN pay_transfer_order.error_code IS '错误�?;
...
COMMENT ON COLUMN pay_transfer_order.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_transfer_order.version IS '乐观�?;
COMMENT ON COLUMN pay_transfer_order.deleted IS '删除标志';
COMMENT ON COLUMN pay_transfer_order.mch_no IS '商户�?;
COMMENT ON COLUMN pay_transfer_order.app_id IS '应用�?;
...
COMMENT ON COLUMN pay_vbill_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_vbill_isv_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_vbill_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_vbill_sub_config.version IS '版本�?;
COMMENT ON COLUMN pay_vbill_sub_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_vbill_sub_config.mno IS '天阙商户�?;
COMMENT ON COLUMN pay_vbill_sub_config.enable IS '是否启用';
COMMENT ON COLUMN pay_vbill_sub_config.app_id IS '商户AppId';
COMMENT ON COLUMN pay_vbill_sub_config.read_system IS '读取服务商配�?;
...
COMMENT ON COLUMN pay_vbill_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_vbill_sub_config.isv_no IS '服务商号';
COMMENT ON TABLE pay_vbill_sub_config IS '随行付特约商户配�?;
...
COMMENT ON COLUMN pay_wechat_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_wechat_isv_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_wechat_isv_config.api_key_v2 IS '商户平台「API安全」中�?APIv2 密钥';
COMMENT ON COLUMN pay_wechat_isv_config.api_key_v3 IS '商户平台「API安全」中�?APIv3 密钥';
COMMENT ON COLUMN pay_wechat_isv_config.app_secret IS 'APPID对应的接口密码，用于获取微信公众号jsapi支付时使�?;
...
COMMENT ON COLUMN pay_wechat_isv_config.cert_serial_no IS '证书序列�?;
...
COMMENT ON TABLE pay_wechat_isv_config IS '微信服务商配�?;
...
COMMENT ON COLUMN pay_wechat_pay_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_wechat_pay_config.version IS '版本�?;
COMMENT ON COLUMN pay_wechat_pay_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_wechat_pay_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_wechat_pay_config.mch_no IS '商户�?;
...
COMMENT ON COLUMN pay_wechat_pay_config.api_key_v2 IS '商户平台「API安全」中�?APIv2 密钥';
COMMENT ON COLUMN pay_wechat_pay_config.api_key_v3 IS '商户平台「API安全」中�?APIv3 密钥';
COMMENT ON COLUMN pay_wechat_pay_config.app_secret IS 'APPID对应的接口密码，用于获取微信公众号jsapi支付时使�?;
...
COMMENT ON COLUMN pay_wechat_pay_config.cert_serial_no IS '商户API证书序列�?;
...
COMMENT ON COLUMN pay_wechat_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_wechat_sub_config.version IS '版本�?;
COMMENT ON COLUMN pay_wechat_sub_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_wechat_sub_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_wechat_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_wechat_sub_config.sub_mch_id IS '微信特约商户�?二级商户�?;
...
COMMENT ON COLUMN pay_yeepay_isv_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_yeepay_isv_config.version IS '版本�?;
...
COMMENT ON COLUMN pay_yeepay_isv_config.merchant_no IS '商户�?;
...
COMMENT ON COLUMN pay_yeepay_isv_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_yeepay_isv_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_yeepay_isv_config.yop_isv_no IS '易宝服务商号';
COMMENT ON TABLE pay_yeepay_isv_config IS '易宝服务商支付配�?;
...
COMMENT ON COLUMN pay_yeepay_sub_config.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN pay_yeepay_sub_config.version IS '版本�?;
COMMENT ON COLUMN pay_yeepay_sub_config.deleted IS '删除标志';
COMMENT ON COLUMN pay_yeepay_sub_config.isv_no IS '服务商号';
COMMENT ON COLUMN pay_yeepay_sub_config.mch_no IS '商户�?;
COMMENT ON COLUMN pay_yeepay_sub_config.app_id IS '应用�?;
COMMENT ON COLUMN pay_yeepay_sub_config.enable IS '是否启用';
COMMENT ON COLUMN pay_yeepay_sub_config.merchant_no IS '商户�?;
...
COMMENT ON TABLE pay_yeepay_sub_config IS '易宝支付子商户配�?;
...
COMMENT ON COLUMN starter_audit_login_log.login IS '登录成功状�?;
...
COMMENT ON COLUMN starter_audit_login_log.browser IS '浏览器类�?;
...
COMMENT ON COLUMN starter_audit_operate_log.success IS '操作状�?;
...
COMMENT ON COLUMN starter_audit_operate_log.browser IS '浏览器类�?;
...
COMMENT ON COLUMN starter_file_platform.last_modified_time IS '最后修改时�?;
COMMENT ON COLUMN starter_file_platform.version IS '版本�?;
...
COMMENT ON COLUMN starter_file_upload_info.size IS '文件大小，单位字�?;
COMMENT ON COLUMN starter_file_upload_info.filename IS '文件名称';
COMMENT ON COLUMN starter_file_upload_info.original_filename IS '原始文件�?;
COMMENT ON COLUMN starter_file_upload_info.base_path IS '基础存储路径';
COMMENT ON COLUMN starter_file_upload_info.path IS '存储路径';
COMMENT ON COLUMN starter_file_upload_info.ext IS '文件扩展�?;
...
COMMENT ON COLUMN starter_file_upload_info.th_url IS '缩略图访问路�?;
COMMENT ON COLUMN starter_file_upload_info.th_filename IS '缩略图名�?;
...
COMMENT ON COLUMN starter_file_upload_info.object_type IS '文件所属对象类型，例如用户头像，评价图�?;
COMMENT ON COLUMN starter_file_upload_info.metadata IS '文件元数�?;
COMMENT ON COLUMN starter_file_upload_info.user_metadata IS '文件用户元数�?;
...
COMMENT ON COLUMN starter_file_upload_info.attr IS '附加属�?;
...
COMMENT ON TABLE starter_file_upload_info IS '文件记录�?;
...
COMMENT ON INDEX idx_pay_adapay_config_app_id IS '汇付支付配置应用号索�?;
...
COMMENT ON INDEX biz_order_no IS '商户支付订单号索�?;
...
COMMENT ON INDEX order_no IS '支付订单号索�?;
...
COMMENT ON INDEX idx_pay_dougong_isv_config_isv_no IS '斗拱服务商配置服务商号索�?;
...
COMMENT ON INDEX idx_pay_dougong_sub_config_app_id IS '斗拱特约商户配置应用号索�?;
...
COMMENT ON INDEX idx_pay_hkrt_isv_config_isv_no IS '海科服务商配置服务商号索�?;
...
COMMENT ON INDEX idx_pay_leshua_isv_config_isv_no IS '乐刷服务商配置服务商号索�?;
...
COMMENT ON INDEX refund_biz_order_no IS '商户支付订单号索�?;
...
COMMENT ON INDEX refund_order_no IS '支付订单号索�?;
CREATE INDEX refund_out_order_no ON pay_refund_order USING btree (
                                                                               out_order_no COLLATE pg_catalog.default pg_catalog.text_ops ASC NULLS LAST
    );
COMMENT ON INDEX refund_out_order_no IS '通道支付订单号索�?;
...
COMMENT ON INDEX out_trade_no IS '通道交易号索�?;
...
COMMENT ON INDEX trade_no IS '本地交易号索�?;
...
COMMENT ON INDEX transfer_biz_transfer_no IS '商户转账号索�?;
...
COMMENT ON INDEX transfer_out_transfer_no IS '通道转账号索�?;
...
COMMENT ON INDEX transfer_transfer_no IS '转账号索�?;
...
COMMENT ON INDEX idx_pay_vbill_sub_config_app_id IS '随行付子商户配置应用号索�?;
...
COMMENT ON INDEX idx_pay_wechat_isv_config_isv_no IS '微信服务商配置服务商号索�?;
...
COMMENT ON INDEX idx_pay_wechat_pay_config_app_id IS '微信支付配置应用号索�?;
...
COMMENT ON INDEX idx_pay_wechat_sub_config_app_id IS '微信特约商户配置应用号索�?;
