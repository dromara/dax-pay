...
INSERT INTO "public"."iam_perm_menu" VALUES (900001, 304, 'iam:social:login-config', 'admin', 'SocialLoginConfig', '三方平台登录', 'Third-party Platform Login', 'menu.system.config.socialLogin', 'lucide:share-2', 'f', 'f', 'views/iam/social/social-login-config', '/system/config/social-login', NULL, 5, 'f', 't', 'f', 1, 1, 0, 'f', 'menu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO "public"."iam_perm_menu" VALUES (310, 308, 'system:notify:wechat-config', 'admin', 'WechatConfig', '公众号配置', 'Wechat Config', 'menu.system.notify.wechatConfig', 'lucide:settings-2', 'f', 'f', '/system/notify/wechat-config/index', '/system/notify/wechat-config', NULL, 30, 'f', 't', 'f', 1, 1, 0, 'f', 'menu', NULL, NULL, NULL, NULL, NULL, '2026-07-09 00:00:00+00', '2026-07-09 00:00:00+00', NULL);
INSERT INTO "public"."iam_perm_menu" VALUES (311, 308, 'system:notify:wechat-message', 'admin', 'WechatMessage', '微信通知记录', 'Wechat Message', 'menu.system.notify.wechatMessage', 'lucide:mail', 'f', 'f', '/system/notify/wechat-message/index', '/system/notify/wechat-message', NULL, 40, 'f', 't', 'f', 1, 1, 0, 'f', 'menu', NULL, NULL, NULL, NULL, NULL, '2026-07-09 00:00:00+00', '2026-07-09 00:00:00+00', NULL);
