...
-- 抖音通道旧直连应用体系下线: 删除已废弃的直连应用/能力/授权配置表
-- 抖音改用 payment-core 跨通道通用应用模式(对齐微信), 应用身份迁移至 dy_mch_app / dy_channel_app_capability 统一体系
...
DROP SEQUENCE IF EXISTS "public"."douyin_direct_app_capability_id_seq";
