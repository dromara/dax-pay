...
INSERT INTO `starter_quartz_job` VALUES (1546857070483939328, '支付单超时检测(Redis)', 'org.dromara.daxpay.service.task.PayExpiredTimeTask', '0/5 * * * * ? *', NULL, 0, '检测超时的支付单, 超时后调用同步事件状态修复', 1399985191002447872, '2022-07-12 22:00:39', 1399985191002447872, '2024-06-03 19:18:14', 9, 0);
INSERT INTO `starter_quartz_job` VALUES (1761419490908958720, '客户系统通知重发任务', 'org.dromara.daxpay.service.task.ClientNoticeSendTask', '0/1 * * * * ? *', '', 0, '每秒调用一下当前需要进行通知的任务', 1399985191002447872, '2024-02-24 23:55:07', 1399985191002447872, '2024-05-09 17:13:10', 5, 0);
INSERT INTO `starter_quartz_job` VALUES (1764664552203743232, '支付宝定时对账', 'org.dromara.daxpay.service.task.ReconcileTask', '0 0 11 * * ? *', '{\"channel\":\"ali_pay\",\"n\":1}', 0, '', 1399985191002447872, '2024-03-04 22:49:50', 1399985191002447872, '2024-05-09 17:13:10', 6, 0);
INSERT INTO `starter_quartz_job` VALUES (1764667388106887168, '微信支付定时对账', 'org.dromara.daxpay.service.task.ReconcileTask', '0 0 11 * * ? *', '{\"channel\":\"wechat_pay\",\"n\":1}', 0, '', 1399985191002447872, '2024-03-04 23:01:06', 1399985191002447872, '2024-05-09 17:13:10', 6, 0);
INSERT INTO `starter_quartz_job` VALUES (1767553847839141888, '退款订单定时同步', 'org.dromara.daxpay.service.task.RefundSyncTask', '0 * * * * ? *', '', 0, '', 1399985191002447872, '2024-03-12 22:10:52', 1399985191002447872, '2024-05-09 17:13:10', 4, 0);
INSERT INTO `starter_quartz_job` VALUES (1787464504578744320, '自动分账定时任务', 'org.dromara.daxpay.service.task.AllocationAutoStartTask', '0/10 * * * * ? *', '', 0, '', 1399985191002447872, '2024-05-06 20:48:42', 1399985191002447872, '2024-05-09 17:13:10', 2, 0);
INSERT INTO `starter_quartz_job` VALUES (1787470450809954304, '自动分账信息同步和完结接口', 'org.dromara.daxpay.service.task.AllocationSyncTask', '0/10 * * * * ? *', '', 0, '', 1399985191002447872, '2024-05-06 21:12:20', 1399985191002447872, '2024-05-09 17:13:10', 2, 0);
INSERT INTO `starter_quartz_job` VALUES (1797588916837670912, '支付单超时检测(数据库)', 'org.dromara.daxpay.service.task.PayExpiredByDbTimeTask', '0/20 * * * * ? *', '', 0, '检测超时的支付单, 超时后调用同步事件状态修复', 1399985191002447872, '2024-06-03 19:19:30', 1399985191002447872, '2024-06-03 19:22:28', 5, 0);
