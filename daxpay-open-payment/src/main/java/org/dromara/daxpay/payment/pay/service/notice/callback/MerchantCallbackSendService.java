...
import org.dromara.daxpay.payment.pay.enums.NoticeSendTypeEnum;
import org.dromara.daxpay.payment.pay.service.assist.PaymentAssistService;
import org.dromara.daxpay.payment.pay.service.notice.MerchantNoticeAssistService;
...
public class MerchantCallbackSendService {
    ...
    public void sendData(MerchantCallbackTask task, boolean autoSend){
        ...
        try {
            // 构造通知消息并签名
            var daxResult = new DaxNoticeResult<>(SUCCESS_CODE, JacksonUtil.parseObj(task.getContent()), SUCCESS_MSG)
