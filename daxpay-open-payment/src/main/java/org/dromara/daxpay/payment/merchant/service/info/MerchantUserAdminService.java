...
public class MerchantUserAdminService {
    ...
    public PageResult<MerchantUserResult> page(PageParam pageParam, MerchantUserQuery query){
        ...
        wrapper.innerJoin(UserInfo.class,UserInfo::getId, MerchantUser::getUserId)
                .innerJoin(Merchant.class,Merchant::getMchNo, MerchantUser::getMchNo)
                .selectAll(UserInfo.class)
                .selectAll(Merchant.class)
        ...
        var page = merchantUserManager.selectJoinListPage(mpPage, MerchantUserResult.class, wrapper);
