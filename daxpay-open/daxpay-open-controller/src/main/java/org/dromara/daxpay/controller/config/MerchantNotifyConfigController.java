...
import org.dromara.daxpay.service.merchant.param.config.NotifySubscribeParam;
 ...
 */
@Validated
@RequestGroup(groupCode = "MerchantNotifyConfig", groupName = "商户通知配置", moduleCode = "merchant")
@Tag(name = "商户订阅通知配置")
@RestController
