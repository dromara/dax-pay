...
@Schema(title = "分账订单明细")
public class AllocDetailVo extends MchResult {
    ...
    @Trans(type = TransType.SIMPLE, target = AllocReceiver.class, fields = AllocReceiver.Fields.receiverName, ref = AllocDetailVo.Fields.name)
