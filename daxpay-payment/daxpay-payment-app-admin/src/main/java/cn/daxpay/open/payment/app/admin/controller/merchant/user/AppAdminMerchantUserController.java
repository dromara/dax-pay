package cn.daxpay.open.payment.app.admin.controller.merchant.user;

import cn.daxpay.open.payment.app.admin.service.merchant.user.AppAdminMerchantUserService;
...
@RestController
@RequestMapping("/app-admin/merchant/user")
@RequiredArgsConstructor
public class AppAdminMerchantUserController {
    ...
    public Result<Void> banBatch(
            @RequestBody @NotEmpty(message = "{validation.field.userIds.notEmpty}") List<Long> userIds) {
    ...
    public Result<Void> unlockBatch(
            @RequestBody @NotEmpty(message = "{validation.field.userIds.notEmpty}") List<Long> userIds) {
