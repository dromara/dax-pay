package cn.daxpay.open.payment.appadmin.controller.merchant.config;

import cn.daxpay.open.payment.appadmin.service.merchant.config.AppAdminMchAppNotifyConfigService;
...
@RestController
@RequestMapping("/app-admin/merchant/app-notify-config")
@RequiredArgsConstructor
public class AppAdminMchAppNotifyConfigController {
