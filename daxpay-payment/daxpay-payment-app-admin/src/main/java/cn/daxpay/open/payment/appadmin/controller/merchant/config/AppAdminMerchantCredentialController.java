...
import cn.daxpay.open.payment.appadmin.service.merchant.config.AppAdminMerchantCredentialService;
...
@RestController
@RequestMapping("/app-admin/merchant/credential")
@RequiredArgsConstructor
public class AppAdminMerchantCredentialController {
