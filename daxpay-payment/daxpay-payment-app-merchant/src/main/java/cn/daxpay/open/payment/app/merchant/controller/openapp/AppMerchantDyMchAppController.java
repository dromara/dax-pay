package cn.daxpay.open.payment.app.merchant.controller.openapp;
...
/// # 商户抖音应用管理（商户移动端）
///
/// 对照商户 Web 端 [MchDyMchAppController]，路径 `/app-mch/douyin/mch-app`。
/// 商户号一律取自 [PaymentContext]，写操作覆盖请求中的 mchNo，防越权。
@PermCode(menuCode = PermCodes.Payment.Douyin.MchApp.MENU)
@Validated
@Tag(name = "商户抖音应用管理(商户移动端)")
@RestController
@RequestMapping("/app-mch/douyin/mch-app")
@RequiredArgsConstructor
public class AppMerchantDyMchAppController {
