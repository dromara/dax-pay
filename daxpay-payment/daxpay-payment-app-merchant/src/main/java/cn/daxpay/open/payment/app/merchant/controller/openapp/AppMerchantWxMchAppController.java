...
/// # 商户微信应用管理（商户移动端）
///
/// 对照商户 Web 端 [MchWxMchAppController]，路径 `/app-mch/wx/mch-app`。
/// 商户号一律取自 [PaymentContext]，写操作覆盖请求中的 mchNo，防越权。
@PermCode(menuCode = PermCodes.Payment.Wx.MchApp.MENU)
@Validated
@Tag(name = "商户微信应用管理(商户移动端)")
@RestController
@RequestMapping("/app-mch/wx/mch-app")
@RequiredArgsConstructor
public class AppMerchantWxMchAppController {
